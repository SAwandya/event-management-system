insert into event(date, id, description, location, name) values(current_date(), 1001 , 'this is first event', 'colombo', 'event 1')
insert into event(date, id, description, location, name) values(current_date(), 1002 , 'this is second event', 'colombo', 'event 2')
insert into event(date, id, description, location, name) values(current_date(), 1003 , 'this is third event', 'colombo', 'event 3')
